	...
	<div class="table-responsive">
		<table class="table table-striped table-bordered " >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Black Logo', (isset($fields['black_logo']['language'])? $fields['black_logo']['language'] : array())) }}</td>
						<td>{{ $row->black_logo}} </td>
