				...
				{!! Form::hidden('id', $row['id']) !!}					
						...
						<div class="favicon-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["favicon"],"/uploads/images") !!}
									  ...
									  <div class="form-group row  " >
										<label for="Black Logo" class=" control-label col-md-4 text-left"> Black Logo </label>
										<div class="col-md-6">
										  
						<div class="fileUpload btn " > 
						    <span>  <i class="fa fa-camera"></i>  </span>
						    <div class="title"> Browse File </div>
						    <input type="file" name="black_logo" class="upload"   accept="image/x-png,image/gif,image/jpeg"     />
						</div>
						<div class="black_logo-preview preview-upload">
							{!! SiteHelpers::showUploadedFile( $row["black_logo"],"/uploads/images") !!}
						</div>
